...
AlexaSkill.prototype.execute = function execute(event, context) {
    try {
        ...
        if (this.appId && applicationId !== this.appId) {
            console.error(`The applicationIds don't match : ${applicationId} and ${this.appId}`);
...
function createSpeechObject(optionsParam) {
    if (optionsParam.type === AlexaSkill.speechOutputType.SSML) {
        return {
